insert into article (title, contnet, hashtag, create_by, modified_by, create_at, modified_at)
...
insert into article_comment (article_id, content, create_at, modified_at, create_by, modified_by) values
